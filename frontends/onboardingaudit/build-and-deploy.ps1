# Script optimizado para build y deploy de onboardingaudit
Write-Host "Build y Deploy - OnboardingAudit (Optimizado)" -ForegroundColor Cyan
...
# Build solo onboardingaudit
Write-Host "Construyendo onboardingaudit..." -ForegroundColor Yellow
Set-Location "frontends/onboardingaudit"
npm run build
