...
export default function OnboardingAuditForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800">
      <Head>
        <title>Onboarding Audit Form - UayLabs Venture Builder</title>
        <meta name="description" content="Submit your onboarding audit request. We'll review your signup flow and deliver a 2-3 page report with actionable recommendations." />
        <meta name="keywords" content="onboarding audit, user experience, conversion optimization, startup growth" />
        <meta property="og:title" content="Onboarding Audit Form - UayLabs" />
        <meta property="og:description" content="Submit your onboarding audit request with actionable recommendations." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://uaylabs.web.app/onboardingaudit/form" />
      </Head>
